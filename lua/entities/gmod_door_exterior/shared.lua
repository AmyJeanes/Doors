...
---@overload fun(self: gmod_door_exterior, name: "FindingPositionFailed", id: string, func: fun(self: gmod_door_exterior, arg1: gmod_door_interior, creator: Player, res: Vector, ...))
